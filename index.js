document.addEventListener("DOMContentLoaded", function () {
  ...
  // Function to pause the game (if needed)
  function pauseGame() {
    isGameRunning = false;
  ...
  // Ensure the background is drawn only after the image is loaded
  backgroundImage.onload = () => {
    // Start the animation loop only after the image is loaded
    animate();
  };
  ...
  function animate() {
    ...
    // Update and draw player, asteroids, lasers, enemies, etc.
    player.update();
    updateAsteroids();
    updateLasers();
    updateEnemies();
